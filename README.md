...
<img width="813" height="1026" alt="image" src="https://github.com/user-attachments/assets/57067886-874d-4ecf-badd-13893d1a4847" />

该架构遵循分层职责模型：控制器层处理 HTTP 请求，编排器决定由哪个 Agent 处理请求，AI 服务层将记忆、工具、护栏和 LLM 组装在一起，而监控子系统在不阻塞主流程的前提下并行观察所有操作。
